...
-- Dumping data for table penggajihan.bagian: ~3 rows (approximately)
...
-- Dumping data for table penggajihan.bagian_karyawan: ~18 rows (approximately)
...
-- Dumping data for table penggajihan.jabatan: ~5 rows (approximately)
...
-- Dumping data for table penggajihan.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping data for table penggajihan.karyawan: ~8 rows (approximately)
...
-- Dumping data for table penggajihan.lokasi: ~3 rows (approximately)
...
-- Dumping data for table penggajihan.penggajian: ~18 rows (approximately)
...
-- Dumping data for table penggajihan.pengguna: ~8 rows (approximately)
...
-- Dumping data for table penggajihan.presensi: ~552 rows (approximately)
